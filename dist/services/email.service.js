...
function buildTransporter() {
    ...
    if (!host || !user || !pass) {
        throw new appError_1.default("Email service is not configured", 500);
    }
...
function buildOtpEmailTemplate(input) {
    ...
    const actionText = input.purpose === "account_verification"
        ? "verify your account"
        : "reset your password";
    const subject = input.purpose === "account_verification"
        ? "Verify Your Account"
