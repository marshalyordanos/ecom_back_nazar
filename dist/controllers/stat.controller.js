...
const statService = __importStar(require("../services/stat.service"));
async function getEcommerceUsers(req, res, next) {
    try {
...
async function getEcommerceSummary(req, res, next) {
    try {
