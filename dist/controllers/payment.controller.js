...
exports.refundPayment = exports.capturePayment = exports.getPaymentById = exports.listPayments = void 0;
...
exports.getPaymentById = (0, catchAsync_1.default)(async (req, res, _next) => {
    const payment = await paymentService.getPaymentById(req.params.id);
    res.status(200).json(payment);
});
exports.capturePayment = (0, catchAsync_1.default)(async (req, res, _next) => {
    const payment = await paymentService.capturePayment(req.params.id);
    res.status(200).json(payment);
});
exports.refundPayment = (0, catchAsync_1.default)(async (req, res, _next) => {
