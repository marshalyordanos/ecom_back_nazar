...
exports.getSyncLogById = exports.listSyncLogs = exports.triggerSync = void 0;
const catchAsync_1 = __importDefault(require("../utils/catchAsync"));
const syncService = __importStar(require("../services/sync.service"));
const queryParser_1 = require("../utils/queryParser");
exports.triggerSync = (0, catchAsync_1.default)(async (req, res, _next) => {
...
exports.listSyncLogs = (0, catchAsync_1.default)(async (req, res, _next) => {
    const query = (0, queryParser_1.parseListQuery)(req);
    const shopId = req.query.shopId;
    const result = await syncService.listSyncLogs(shopId, query);
    res.status(200).json(result);
});
exports.getSyncLogById = (0, catchAsync_1.default)(async (req, res, _next) => {
