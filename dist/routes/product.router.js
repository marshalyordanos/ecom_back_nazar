...
router.get("/variants", auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)("admin"), productController.listVariants);
...
router.post("/variants/:variantId/option-values", auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)("admin"), productController.setVariantOptionValues);
router.delete("/variants/:variantId/option-values/:optionValueId", auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)("admin"), productController.removeVariantOptionValue);
router.post("/variants/:variantId/option-values/:optionValueId", auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)("admin"), productController.assignVariantOptionValue);
...
router.patch("/options/values/:valueId", auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)("admin"), productController.updateOptionValue);
...
router.patch("/options/:optionId", auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)("admin"), productController.updateVariantOption);
...
router.patch("/:id", auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)("admin"), productController.updateProduct);
router.delete("/:id", auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)("admin"), productController.deleteProduct);
router.post("/:id/variants", auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)("admin"), (0, multer_1.uploadSingleImage)("image"), productController.createVariant);
